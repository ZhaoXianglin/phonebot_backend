...
def geneExpBasedOnProductFeatures(user_preference_model, currentItem, explanation_type, oldItem=None):
    ...
    if explanation_type == 3:
        ...
        if brand_mark:
            explanation = "I recommend this phone because I have {0} by myself and think it {1} <b>brand</b>, <b>{2}</b> and <b>{3}</b>.".format(
                random.choice(slot_my), random.choice(slot_reason),
                attr_to_name(topkey1, 0), attr_to_name(topkey2, 0))
        else:
            explanation = "I recommend this phone because I have {0} by myself and think it {1} <b>{2}</b> and <b>{3}</b>.".format(
                random.choice(slot_my), random.choice(slot_reason),
                attr_to_name(topkey1, 0), attr_to_name(topkey2, 0))
