...
def calculate_dissimilarity_between_two_sets(user_listened_songs_info_df, crit_item_info_df, combined_songs_info_df,
                                             categorical_attributes, numerical_attributes):
    # Step 1: Preprocessing -> construct feature vectors
    user_listened_songs_vectors, crit_item_vectors = preprocessing_constrctur_feature_vectors(
        user_listened_songs_info_df, crit_item_info_df, combined_songs_info_df, categorical_attributes,
        numerical_attributes)

    # Step 2: Dissimilarity Calculation
    dissimilarity_between_two_sets = calculate_dissimilarity_between_two_sets_of_vectors(user_listened_songs_vectors,
                                                                                         crit_item_vectors)
...
def calculate_entropy_for_set(combined_songs_info_df, categorical_attributes, numerical_attributes):
    ...
    for attribute in numerical_attributes:
        ...
        songs_info_df[attribute] = pd.cut(songs_info_df[attribute], attribute_intervalindex, right=False,
...
def calculate_unexpectedness_for_set(user_listened_songs_info_df, crit_item_info_df, combined_songs_info_df,
                                     categorical_attributes, numerical_attributes):
    # Step 1: Preprocessing -> construct feature vectors
    user_listened_songs_vectors, crit_item_vectors = preprocessing_constrctur_feature_vectors(
        user_listened_songs_info_df, crit_item_info_df, combined_songs_info_df, categorical_attributes,
    ...
    unexpectedness_for_set = calculate_unexpectedness_based_on_user_listened_songs(user_listened_songs_vectors,
                                                                                   crit_item_vectors)
