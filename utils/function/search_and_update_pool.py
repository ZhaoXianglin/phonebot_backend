...
def update_recommendation_pool(user_preference_model, user_critique_preference, new_item_pool, integrated_item_pool,
                               max_item_pool_number, categorical_attributes, numerical_attributes, key, method, alpha):
    sorted_estimated_score_dict = recommendation.compute_recommendation_by_MAUT(user_preference_model,
                                                                                user_critique_preference,
                                                                                integrated_item_pool,
                                                                                len(integrated_item_pool),
                                                                                categorical_attributes,
                                                                                numerical_attributes, method, alpha)
